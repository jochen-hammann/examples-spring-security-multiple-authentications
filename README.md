# Spring Security: Multiple Authentications

This example shows the implementation of multiple different authentications including erroro handling. The authentication methods are identified by the used URL.
...
* [Florian Hopf: Spring Security and Multiple Filter Chains](http://blog.florian-hopf.de/2017/08/spring-security.html)

---

* [FatalErrors: Custom exception handling of Spring Security](https://www.fatalerrors.org/a/custom-exception-handling-of-spring-security.html)
* [devglan: Exception Handling In Spring Security](https://www.devglan.com/spring-security/exception-handling-in-spring-security)
* [Baeldung: Spring Security – Customize the 403 Forbidden/Access Denied Page](https://www.baeldung.com/spring-security-custom-access-denied-page)
